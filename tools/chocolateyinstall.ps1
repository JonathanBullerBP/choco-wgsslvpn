...
$url        = https://cdn.watchguard.com/SoftwareCenter/Files/MUVPN_SSL/12_10/WG-MVPN-SSL_12_10.exe'' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'WatchGuard Mobile VPN with SSL client*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
